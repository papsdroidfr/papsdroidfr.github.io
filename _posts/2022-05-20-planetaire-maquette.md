...
{: .text-justify}
Pour comprendre la sorcellerie qui se cache derrière ce choix de roues dentées qui permet d'obtenir une période de rotation très précise, lisez [cet article](https://www.papsdroid.fr/post/mercure).
{: .text-justify}

...
{: .text-justify}
### bilbiotèque aioble
Cette documentation encourage fortement à utiliser la [bibliotèque aioble](https://github.com/micropython/micropython-lib/tree/master/micropython/bluetooth/aioble). Pour installer cette blibliothèque sur la carte il faut créer un dossier **/aioble** et y créer tous les fichier qui figure dans le dossier aioble du lien Github ci-dessus.
{: .text-justify} 
* Pour **créer un dossier** sur la carte depuis Thonny: cliquez sur "Ouvrir", choisisez "Appareil Micropython" et vous devriez voir au dessus de la taille(octes) un petit menu avec 3 barres horizontales (il est bien planqué ...): cliquez dessus et ensuite sur "Nouveau dossier..."
{: .text-justify}
* une fois le dossier créé, cliquez ensuite sur le gros + vert, copier/coller un des programmes python du répertoire aioble du github, et sauvegarder le fichier sur l'appareil micropython avec exactement le même nom que sur github: recommencez pour tous les 9 programmes.
{: .text-justify}
